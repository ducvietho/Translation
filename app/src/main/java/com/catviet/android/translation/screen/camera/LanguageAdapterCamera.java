...
public class LanguageAdapterCamera extends RecyclerView.Adapter<LanguageAdapterCamera.ViewHolder> {
    private List<Language> mLanguages;
    private OnClickItem<Language> mOnClickItem;
    private int mType;
    private int selectedPostision = -1;

    public LanguageAdapterCamera(List<Language> languages, OnClickItem<Language> onClickItem, int type, int position) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Language language, final int position) {
            ...
            if (position == selectedPostision) {
                mLanguage.setTextColor(itemView.getContext().getResources().getColor(R.color.orange_4));
            } else {
                mLanguage.setTextColor(Color.WHITE);
            }
        }
    }
}
